 ...
 * Converte os Exceptions de Erros 405 - Not Allowed
	Exemplo aqui lek: curl -X PATCH  --verbose http://localhost:8000/book
...
$container['notFoundHandler'] = function ($container) {
    return function ($request, $response) use ($container) {
        return $container['response']
            ->withStatus(404)
            ->withHeader('Content-Type', 'Application/json')
            ->withJson(['message' => 'Page not found. xD']);
    };
};
...
/**
 * Token do nosso JWT (Jason Web Token)
 */
$container['secretkey'] = "top10";
